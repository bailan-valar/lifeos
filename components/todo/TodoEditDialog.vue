      ...
      <div v-if="quickCreateForm.visible" class="quick-create-overlay" @click.self="onCancelQuickCreate">
        <div class="quick-create-dialog liquid-glass">
          ...
          <div class="form-group">
            ...
            <div class="icon-grid">
              <button
                v-for="icon in ['solar:check-circle-linear', 'solar:star-linear', 'solar:heart-linear', 'solar:flag-linear', 'solar:bookmark-linear', 'solar:tag-linear', 'solar:briefcase-linear', 'solar:home-linear']"
                :key="icon"
                type="button"
          ...
          <div class="form-group">
            ...
            <div class="color-grid">
              <button
                v-for="color in quickCreateColors"
                :key="color"
                type="button"
                class="color-option"
...
// 快捷创建待办类型
const onQuickCreateType = (typeName: string) => {
  quickCreateForm.visible = true
  quickCreateForm.name = typeName
  quickCreateForm.icon = 'solar:check-circle-linear'
  quickCreateForm.color = quickCreateColors[Math.floor(Math.random() * quickCreateColors.length)]
}
